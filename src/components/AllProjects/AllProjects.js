    ...
    const projects = this.state.projects.map(project => {
      ...
      return (
        ...
        >
          ...
          <div className="work-project-title-holder">
    ...
    return (
      <div>
        <Helmet>
          <meta
            name="description"
            content="Herman Slyngstadli - Design student specialising in Interaction and Service Design at NTNU, Norway."
          />
          <meta
            name="keywords"
            content="service design, interaction design, design, portfolio, ux, ui, herman slyngstadli"
          />
