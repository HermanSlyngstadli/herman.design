...
class ProjectPreview extends React.Component {
  ...
  componentDidMount() {
    fetch(
      "https://slyngstadli.no/herman/wp-json/wp/v2/posts?slug=" +
        this.state.slug
    )
      ...
      return (
        <div key={project.id}>
          <Helmet>
            ...
            <meta
              property="og:url"
              content={"https://herman.design/work/" + project.slug}
            />
            <meta property="og:type" content="website" />
            <meta
              property="og:title"
              content={project.title.rendered + " | Herman Slyngstadli"}
            />
          ...
          <article>
            ...
            <div className="project-component-small-container back-to-projects">
              <Link to="/work">
                <span className="back-to-projects-arrow"></span>
                <span className="back-to-projects-text">{"Back to work"}</span>
              </Link>
            </div>
            <div>{this.projectContent(project.content.rendered)}</div>
            <div className="previewed-project-floating-title">
